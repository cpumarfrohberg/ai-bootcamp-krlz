...
from wikiagent.models import JudgeEvaluation, JudgeResult, SearchAgentAnswer, TokenUsage
...
async def evaluate_answer(
    ...
    Args:
        ...
        answer: The SearchAgentAnswer from the Wikipedia agent
