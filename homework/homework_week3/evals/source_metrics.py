...
def calculate_hit_rate(
    ...
    Args:
        expected_sources: List of expected Wikipedia page titles
        actual_sources: List of actual Wikipedia page titles from agent
...
def calculate_mrr(
    ...
    Args:
        expected_sources: List of expected Wikipedia page titles
        actual_sources: List of actual Wikipedia page titles from agent (in order)
